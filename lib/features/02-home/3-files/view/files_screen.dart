              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      GestureDetector(
                        onTap: () => navToWithRTLAnimation(context, DownloadsScreen()),
                        child: Container(
                          height: 62,
                          width: 165,
                      ...
                      GestureDetector(
                        onTap: () => navToWithRTLAnimation(context, FileManagerScreen()),
                        child: Container(
                          height: 62,
                          width: 165,
                          decoration: BoxDecoration(
                              ...
                              children: [
                                IconColumnWidgets(
                                  ...
                                  onPressed: () async {
                                    var perm = await Permission.storage.request();
                                    if (perm.isGranted) {
                                      navToWithRTLAnimation(context, VideoView());
                                    } else {
                                      checkPermission();
                                    }
                                  },
                                ...
                                IconColumnWidgets(
                                  onPressed: () async {
                                    var perm = await Permission.storage.request();
                                    if (perm.isGranted) {
                                      navToWithRTLAnimation(context, MusicPlayerListScreen());
                                    } else {
                                      checkPermission();
                                    }
                                  },
                                ...
                                IconColumnWidgets(
                                    onPressed: () async {
                                      ...
                                      if (perm.isGranted) {
                                        pickFile();
                                        navToWithRTLAnimation(context, DocumentViewer());
                                      } else {
                                        checkPermission();
                                      }
                                    },
                                ...
                                IconColumnWidgets(
                                    onPressed: () async {
                                      var perm = await Permission.storage.request();
                                      if (perm.isGranted) {
                                        navToWithRTLAnimation(context, GalleryViewerScreen());
                                      } else {
                                        checkPermission();
                                      }
                                    },
                            ...
                            children: [
                              IconColumnWidgets(
                                  onPressed: () async {
                                    ...
                                    if (perm.isGranted) {
                                      pickFileApk();
                                      navToWithRTLAnimation(context, GetApp());
                                    } else {
                                      checkPermission();
                                    }
                                  },
                              ...
                              IconColumnWidgets(
                                onPressed: () async {
                                  ...
                                  if (perm.isGranted) {
                                    ...
                                    // );
                                    navToWithRTLAnimation(context, WhatsappImage());
                                  } else {
                                    checkPermission();
                                  }
                                },
                              ...
                              IconColumnWidgets(
                                  onPressed: () async {
                                    var perm = await Permission.storage.request();
                                    if (perm.isGranted) {
                                      navToWithRTLAnimation(context, InstagramImage());
                                    } else {
                                      checkPermission();
                                    }
                                  },
                              ...
                              IconColumnWidgets(
                                  onPressed: () async {
                                    var perm = await Permission.storage.request();
                                    if (perm.isGranted) {
                                      navToWithRTLAnimation(context, CompressedFiles());
                                    } else {
                                      checkPermission();
                                    }
                                  },
